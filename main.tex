...
% Glossary setup
\usepackage[acronym, nonumberlist, nogroupskip]{glossaries} % Enables glossary and acronym management.
\usepackage{longtable} % Required for long glossary style
\setglossarystyle{long} % Sets the glossary style to 'long'.
\setlength{\glsdescwidth}{0.8\textwidth} % Sets description column width
\renewenvironment{theglossary}%
  {\begin{longtable}[l]{@{}lp{\glsdescwidth}@{}}}%
  {\end{longtable}}%
\renewcommand{\glossaryentrynumbers}[1]{} % Remove page numbers
\setlength{\LTpre}{0pt} % Space before longtable
...
{%
\renewcommand{\arraystretch}{1.5}% Zeilenabstand im Glossar auf 1.5
\printnoidxglossary[type=acronym,title={Acronyms},style=long]%
}
